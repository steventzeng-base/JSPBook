...
<table border="1" width="631">
  <tr bgcolor="#999999"> 
    <td width="174"><div align="center"><b>書名</b></div></td>
  ...
  <form name="shoppingForm" action="ShoppingServlet" method="POST">
    <tr> 
      <td width="174"><div align="center">JSP 2.0 技術手冊</div></td>
      <td width="101"><div align="center">林上傑</div></td>
      <td width="57"><div align="center">碁峰</div></td>
  ...
  <form name="shoppingForm" action="ShoppingServlet" method="POST">
    <tr> 
      <td width="174"><div align="center">紫牛－讓產品自己說故事</div></td>
      <td width="101"><div align="center">賽斯‧高汀</div></td>
  ...
  <form name="shoppingForm" action="ShoppingServlet" method="POST">
    <tr> 
      <td width="174"><div align="center">1421-中國發現世界</div></td>
      <td width="101"><div align="center">孟西士</div></td>
      <td width="57"><div align="center">遠流</div></td>
  ...
  <form name="shoppingForm" action="ShoppingServlet" method="POST">
    <tr> 
      <td width="174"><div align="center">如何打敗可口可樂</div></td>
      <td width="101"><div align="center">翟若適</div></td>
      <td width="57"><div align="center">聯合文學</div></td>
  ...
  <form name="shoppingForm" action="ShoppingServlet" method="POST">
    <tr> 
      <td width="174"><div align="center">菲奧莉娜逆勢出擊</div></td>
      <td width="101"><div align="center">彼得‧鮑洛斯</div></td>
