<%@ page import="tw.com.javaworld.CH10.Book,java.util.Vector" pageEncoding="UTF-8" %>
<%
...
<table border="1" width="631">
    ...
    <tr>
        ...
        <td><b><%= order.getAuthor() %>
        </b></td>
        <td><b><%= order.getPublisher() %>
        </b></td>
        <td><b>
            <div align="right"><%= order.getPrice() %>
            </div>
        </b></td>
        <td><b>
            <div align="right"><%= order.getQuantity() %>
            </div>
        </b></td>
        <td>
